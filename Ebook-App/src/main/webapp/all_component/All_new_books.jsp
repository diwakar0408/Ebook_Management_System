...
<c:if test="${not empty alredy}">
	...
	List<addbookclass> l1=b.getAllNewBooks();
	%>
	<h3 style="text-align: center; color: green;">New Book</h3>
	<!--start New book-->
					...
					<div class="card-body text-center">
						...
						<div class="row">
							...
							<form action="../addtocart" method="post">
								...
								<input type="hidden" name="requesttype"  value="allnew">
								<input type="hidden" name="userid" value="<%=u.getId()%>">
								<input type="hidden" name="bookname"
									value="<%=a.getBookname()%>"> <input type="hidden"
									name="bookprice" value="<%=a.getPrice()%>"> <input
									type="hidden" name="authorname" value="<%=a.getAuthor()%>">
								<input type="hidden" name="bookcategorie"
									value="<%=a.getBookcategory()%>">
							...
							<a href="view_book.jsp?bookid=<%=a.getBookid()%>"
								...
								href="" class="btn btn-danger btn-sm ml-1"><%=a.getPrice()%><i
