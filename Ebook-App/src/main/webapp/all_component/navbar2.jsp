	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="all_recent_books.jsp"><i class="fa-solid fa-book"></i>Recent
					Book</a></li>
			<li class="nav-item active"><a class="nav-link"
				href="All_new_books.jsp"> <i class="fa-solid fa-book-tanakh"></i>New
					Book
			</a></li>
			<li class="nav-item active"><a class="nav-link disabled"
				href="All_old_books.jsp"><i class="fa-solid fa-book-atlas"></i>Old
					Book</a></li>
		</ul>
